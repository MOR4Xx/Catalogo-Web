...
export default function CardProduct({produto}) {
    return (
        <div
            className="flex flex-col bg-status-escuro border border-black/20 hover:border-black p-4 gap-4 rounded-lg shadow-md h-full">

            <div className="relative w-full h-[250px] rounded-lg overflow-hidden">
                <ImageLoading fill product={produto} className={"w-full h-full"}/>
            </div>
            ...
            <div className="flex flex-col gap-2 flex-1">
                ...
                <span className="text-black font-bold mt-auto">R$ {produto.price.toFixed(2)}</span>
            </div>
